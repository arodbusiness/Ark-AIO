...
YellowBar := A_ScriptDir . "\Captures\YellowBar.jpg"
OrangeBar := A_ScriptDir . "\Captures\OrangeBar.jpg"
CyanBar := A_ScriptDir . "\Captures\CyanBar.jpg"
...
Loop{
	...
	if (AlertsInput){
		if (CheckDC() && DisconnectedInput){
			...
			SetDefaultEndpoint( GetDeviceID(Devices, "MT53") )
			SoundPlay, Disconnected.mp3
			Sleep %SoundDeviceDelay%
			SetDefaultEndpoint( GetDeviceID(Devices, "ASTRO USB Game") )
